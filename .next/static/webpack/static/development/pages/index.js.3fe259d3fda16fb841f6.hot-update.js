  ...
  function Form(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "regionGet", function (e) {
      ...
      if (regionTyped.length >= 2) _this.setState({
        ...
        console.log("https://stage.reyhoon.com/location/query?query=".concat(_this.state.region, "&city=").concat(_this.state.city));
      });
    });
...
//# sourceMappingURL=index.js.3fe259d3fda16fb841f6.hot-update.js.map