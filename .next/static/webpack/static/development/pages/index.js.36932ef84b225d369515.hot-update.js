...
function renderx() {
  var renderdata = FooterTopData.map(function (item) {
    return __jsx("div", {
      ...
      console.log(link); // <li key={link.id} ><a href={link.href}>{link.title}</a></li>
    }) : item.items.map(function (link) {
      console.log(link); // <li key={link.id} ><a href={link.href}><img src={link.src}/></a></li>
    })));
  });
  return renderdata;
} // const  renderFooter=()=>{
...
//# sourceMappingURL=index.js.36932ef84b225d369515.hot-update.js.map