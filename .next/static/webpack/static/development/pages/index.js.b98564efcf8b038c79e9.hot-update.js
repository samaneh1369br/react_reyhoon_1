          ...
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 6:
                  jsonRespone = _context.sent;
                  console.log(jsonRespone);
                  _context.next = 11;
                  break;

                case 10:
                  console.log("HTTP-Error: " + response.status + "بییییییییییییییییییییییییییییییییییییییی");
...
//# sourceMappingURL=index.js.b98564efcf8b038c79e9.hot-update.js.map