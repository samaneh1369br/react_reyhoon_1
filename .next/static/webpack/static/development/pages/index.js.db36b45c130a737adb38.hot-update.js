...
function (_React$Component) {
  ...
  function Form(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "submit", function (e) {
      ...
      if (e.target.querySelector("input[id='txt1']").value && e.target.querySelector("input[id='txt2']").value) {} else {
        ...
        node.querySelector("div[id='nullInput']").innerHtml = "لطفا ورودی را وارد کنید";
        console.log("hi");
      }
    });
...
//# sourceMappingURL=index.js.db36b45c130a737adb38.hot-update.js.map