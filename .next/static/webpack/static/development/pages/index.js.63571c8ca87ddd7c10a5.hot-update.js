...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Form, [{
    ...
    value: function render() {
      ...
      //   this.state.allCityies.provinces.map((city)=>{console.log(city)})
      var filteredCities = this.state.allCityies.filter(Object(react_search_input__WEBPACK_IMPORTED_MODULE_12__["createFilter"])(this.state.searchTerm, 'name'));
      ...
      return __jsx("section", {
        ...
        __self: this
      }, this.state.sugestionCity.map(function (city) {
        return __jsx("li", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 82
...
//# sourceMappingURL=index.js.63571c8ca87ddd7c10a5.hot-update.js.map